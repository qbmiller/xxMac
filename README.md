...
- Todo tasks are stored locally in `todo.db` inside the configuration folder. The database and its SQLite sidecar files move when the configuration folder changes. The first Todo release does not implement iCloud or CloudKit sync.
