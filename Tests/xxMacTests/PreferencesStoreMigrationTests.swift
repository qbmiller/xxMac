...
final class PreferencesStoreMigrationTests: XCTestCase {
    ...
    func testMigratesKnownUserDefaultsKeysIntoPreferencesFile() throws {
        ...
        defaults.set(["/Applications/Utilities"], forKey: "AppSearchExcludedPaths")
        ...
        defaults.set(Data([11]), forKey: "LauncherHistoryRecords")
        defaults.set(100, forKey: "LauncherHistoryMaxItems")
        ...
        XCTAssertEqual(store.stringArray(forKey: "AppSearchExcludedPaths"), ["/Applications/Utilities"])
        ...
        XCTAssertEqual(store.data(forKey: "LauncherHistoryRecords"), Data([11]))
        XCTAssertEqual(store.intObject(forKey: "LauncherHistoryMaxItems"), 100)
